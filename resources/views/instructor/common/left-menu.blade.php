<div class="instructor-profile-left-part bg-white">
    <nav class="account-page-menu">
        <ul>
            ...
            @endif
            <li style="display:none;"><a href="{{ route('instructor.bundle-course.index') }}" class="{{ @$navBundleCourseActiveClass }}" ><span class="iconify mr-15" data-icon="eos-icons:machine-learning-outlined"></span>{{__('Bundles Courses')}}</a></li>
            ...
            <li style="display:none;"><a href="{{route('instructor.certificate.index')}}" class="{{ @$navCertificateActiveClass }}" ><span class="iconify mr-15" data-icon="fluent:certificate-20-regular"></span>{{__('Certificate')}}</a></li>
            ...
            <li style="display:none;"><a href="{{route('instructor.multi_instructor')}}" class="{{@$navInstructorRequestActiveClass}}" ><span class="iconify mr-15" data-icon="fluent:branch-request-20-regular"></span>{{__('Instructor Request')}}</a></li>
