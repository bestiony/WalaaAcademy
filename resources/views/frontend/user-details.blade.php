                            ...
                            <div class="course-tab-nav-wrap course-details-tab-nav-wrap d-flex justify-content-between">
                                <ul class="nav nav-tabs tab-nav-list border-0" id="myTab" role="tablist">
                                     <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="Instructors-tab" data-bs-toggle="tab"
                                            href="#Instructors" role="tab" aria-controls="Instructors"
                                            aria-selected="false">Instructors</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link " id="Courses-tab" data-bs-toggle="tab" href="#Courses"
                                            role="tab" aria-controls="Courses" aria-selected="true"> Therapy Tutorials</a>
                                    </li>
