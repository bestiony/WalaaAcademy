...
@section('content')
    ...
    <header class="hero-area gradient-bg position-relative">
        <video id="video_background" preload="auto" autoplay="autoplay" loop="true" muted="muted" style="position: absolute;top:2%;bottom:0; right:-140px; z-index: 100; width: 1536px; height: 724px;"><source src="https://cc.engwalaa.com//uploads_demo/home/video.mp4" type="video/mp4"><source src="video/video.ogg" type="video/ogg"><source src="video/video.webm" type="video/webm">bgvideo</video>
    ...
    <!-- Video Area Start -->
    <section class="video-area {{ @$home->video_area == 1 ? '' : 'd-none' }}" style="padding-top:88px;background:#fafafa;">
        <div class="container">
    ...
    <section class="special-feature-area p-0 {{ @$home->special_feature_area == 1 ? '' : 'd-none' }}" style="background:#fafafa;">
        <div class="container">
            <div class="row">
 ...
 <!-- Course Instructor and Support Area Start -->
    ...
    <section style="display:none;" class="top-categories-area gradient-bg p-0 {{ @$home->top_category_area == 1 ? '' : 'd-none' }}" style="margin-top:77px;">
 ...
 <!-- Customers Says/ testimonial Area Start -->
    ...
    <section style="display:none;" class="courses-area courses-bundels-area section-t-space section-b-85-space bg-page {{ @$home->bundle_area == 1 ? '' : 'd-none' }}">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- section-left-align-->
    ...
    <section style="display:none;" class="courses-area section-t-space section-b-85-space {{ @$home->courses_area == 1 ? '' : 'd-none' }}">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- section-left-align-->
